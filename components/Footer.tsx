...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-[#1B2847] mt-24">
      ...
      <div className="relative z-10">
        <div className="w-full max-w-5xl px-4 xl:px-0 py-10 lg:pt-16 mx-auto sm:flex items-center justify-between">
          <div className="inline-flex items-center">

            <img src="./logo.png" className="w-44" />
            <div className="border-s border-neutral-700 ps-5 ms-5">
              <p className="text-sm text-neutral-400">2024 RefWise Co.</p>
            </div>

          </div>
          <PopUpForm>
            <Button className=' my-3 w-full sm:w-auto py-2 lg:px-7 rounded-full bg-[#FF5D7D] hover:bg-[#b8435a] z-50 '>
              Contact Us
            </Button>
          </PopUpForm>
